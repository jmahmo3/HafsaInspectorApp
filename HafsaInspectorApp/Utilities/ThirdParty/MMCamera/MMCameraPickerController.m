...
- (MMCameraPickerController *)create {
    NSBundle *frameworkBundle = [NSBundle bundleForClass:[self class]];
    MMCameraPickerController *main = [[UIStoryboard storyboardWithName:@"Main" bundle:frameworkBundle] instantiateViewControllerWithIdentifier:NSStringFromClass([MMCameraPickerController class])];
    return main;
}
